...
<div id="navbar">
  ...
  <div class="dropdown " style="display: inline">
      ...
      <div class="dropdown-menu asd" aria-labelledby="dropdownMenuLink" ">
          <a class="dropdown-item" href="profildinas.html" style="margin: 0px;padding: 0px;">Profil Dinas </a><br>
          <a class="dropdown-item" href="strukturorganisasi.html" style="margin: 0px;padding: 0px;">Struktur Organisasi </a><br>
          <a class="dropdown-item" href="renstra.html" style="margin: 0px;padding: 0px;">Renstra</a><br>
          <a class="dropdown-item" href="renja.html" style="margin: 0px;padding: 0px;">Renja </a><br>
          <a class="dropdown-item" href="lakip.html" style="margin: 0px;padding: 0px;">Lakip </a><br>
          <a class="dropdown-item" href="daftarpejabat.html" style="margin: 0px;padding: 0px;">Daftar Pejabat </a><br> 
      </div>
    </div>
...
<div class="beritabaru">
  ...
  <div class="tulisan"></div>
         <marquee class="tulisan"> Selamat Datang di Situs Resmi Dinas Ketahanan Pangan Daerah Grobogan</marquee>
      </div>

<div class="kadin">
  <img src="css/kutip.png">
  Pangan merupakan soal mati-hidupnya suatu bangsa; apabila kebutuhan pangan rakyat tidak dipenuhi maka “malapetaka”; oleh karena itu perlu usaha secara besar-besaran, radikal, dan revolusioner (Ir. Soekarno)</div> 


      <div class="news" style="z-index: -1;" >
        <div class="judulterbaru"><p style="font-size: 18px;color :#f7b00a;
          border-bottom: 2px solid #d7d9db;margin-bottom: 20px;padding-bottom: 10px;">Berita <b style="color: grey">Terbaru</b> <button class="pencet">Indeks»</button> </p></div>
     
        <div class="kotakberita" style="background-image: url(css/ternak.jpg);z-index: -3;"><div class="judulkotak">Domba akan disembelih menjelang idul adha</div>
            <div class="kotakcover"></div>
        </div>

        <div class="kotakberita"style="background-image: url(css/dele.jpg)"><div class="judulkotak">kebutuhan kedelai di kabupaten grobogan meningkat</div>
          <div class="kotakcover"></div>
        </div>
          
        <div class="kotakberita"style="background-image: url(css/lombokmahal.jpg)"><div class="judulkotak">Kenaikan drastis harga lombok dikabupaten grobogan</div>
          <div class="kotakcover"></div>
        </div>
        
        <div class="kotakberita"style="background-image: url(css/daging.jpg)">
          <div class="judulkotak">ditemukan daging mengandung sakarin</div>
          <div class="kotakcover"></div>
        </div>
     
      </div>
<div class="content2">
<h1><b>PROGAM UNGGULAN</b></h1>
Berikut adalah program unggulan Dinas Ketahanan Pangan Daerah Kabupaten Grobogan<br>
<div class="content2nya"><h2>Technopark</h2>
<img src="css/taman.png" height="100px"><br>merupakan Taman teknologi
</div>

<div class="content2nya"><h2>Food Security</h2><br>
 <img src="css/padi.png"height="190%"><br>merupakan Keamanan Makanan
</div>

<div class="content2nya"><h2>Pasar Pangan</h2>
<img src="css/pasar.png" height="100px"><br>merupakan pasar yang berisi pangan
...
<div class="content4"><h2 style="padding-left: 80px;">Update Harga Pangan Kabupaten Grobogan </h2>
</div> 
